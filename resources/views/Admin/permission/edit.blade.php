                            ...
                            <div class=" form">
                                <form class="cmxform form-horizontal adminex-form" id="permission">
                                            ...
                                            <div class="input-group ">
                                              <span class="input-group-addon">
                                               <i class="fa  fa-lock"></i>
                                                ...
                                                <input type="text" class="form-control" required name="permission_name" value="{{ $info->permission_name }}">
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="input-group ">
                                              <span class="input-group-addon">
                                               <i class="fa  fa-internet-explorer"></i>
                                                ...
                                                <input type="text" class="form-control" name="route" required value="{{ $info->route }}">
                                            </div>
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-sm-8">
                                            <textarea class="form-control "  type="text" name="remark" required id="remark">{{ $info->remark }}</textarea>
                                        </div>
                                    </div>
                                              ...
                                              <span class="input-group-addon">
                                               <i class="fa  fa-bars"></i>
                                                ...
                                                <select name="level" id="" class="form-control" required>
                                                    <option value="1" @if($info->level==1) selected @endif>一级</option>
                                                    <option value="2" @if($info->level==2) selected @endif>二级</option>
                                                    <option value="3" @if($info->level==3) selected @endif>三级</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                              ...
                                              <span class="input-group-addon">
                                               <i class="fa  fa-lock"></i>
                                                ...
                                                <select name="pid" id="" class="form-control" required>
                                                    <option value="0"  @if($info->pid==0) selected @endif>顶级</option>
                                                    @foreach($list as $v)
                                                        <option value="{{ $v->id }}" @if($info->pid==$v->id) selected @endif>{{ $v->permission_name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-8">
                                            <div id="spinner1">
                                                <div class="input-group input-small">
                                                    <input type="text" class="spinner-input form-control" maxlength="4" required name="sort" value="{{ $info->sort }}">
                                        ...
                                        <div class="col-sm-8 icheck">
                                            <div class="flat-green single-row">
                                                <div class="radio " style="padding-left: 0">
                                                    <input tabindex="3" type="radio" name="status" @if($info->status==1)checked @endif id="on" value="1">
                                                    <label for="on">启用</label>
                                                </div>
                                                <div class="radio " >
                                                    <input tabindex="3" type="radio" name="status" @if($info->status==0)checked @endif id="off" value="0">
                                    ...
                                    <div class="form-group menu">
                                        ...
                                        <div class="col-sm-8 icheck">
                                            <div class="flat-green single-row">
                                                <div class="radio " style="padding-left: 0">
                                                    <input tabindex="3" type="radio" name="is_menu" id="yes" @if($info->is_menu==1)checked @endif value="1" required>
                                                    <label for="yes">是</label>
                                                </div>
                                                <div class="radio "  >
                                                    <input tabindex="3" type="radio" name="is_menu" @if($info->is_menu==0)checked @endif id="no" value="0" required>
                                    ...
                                    <div class="form-group menu-element @if($info->level!=1) hide @endif">
                                            ...
                                            <div class="input-group ">
                                              <span class="input-group-addon">
                                               <i class="fa  fa-bars"></i>
                                                ...
                                                <input type="text" class="form-control" name="menu_icon" required value="{{ $info->menu_icon }}">
                                            </div>
                                        </div>
    ...
    <script>
        ...
        $("#submit").click(function () {
            $.ajax({
                type: "put",
                dataType: "json",
                url: "{{ route('permission.update',['permission'=>$info->id]) }}",
                async: true,
